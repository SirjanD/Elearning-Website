...
<section class="edit-comment">
   ...
   <form action="" method="post">
      ...
      <textarea name="update_box" class="box" maxlength="1000" required placeholder="Comment.." cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
      <div class="flex">
...
<section class="watch-video">
   ...
   <?php
         ...
         echo '<p class="empty">Videos not Found!</p>';
      }
   ?>
...
<section class="comments">
   ...
   <h1 class="heading">User Comment</h1>
   ...
   <div class="show-comments">
      ...
      <?php
         ...
         echo '<p class="empty">Comments not found!</p>';
      }
      ?>
      </div>
