...
<section class="edit-comment">
   ...
   <form action="" method="post">
      ...
      <textarea name="update_box" class="box" maxlength="1000" required placeholder="Enter Comment" cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
      <div class="flex">
...
<section class="comments">
   ...
   <div class="show-comments">
      ...
      <?php
         ...
         echo '<p class="empty">Comments not added!</p>';
      }
      ?>
      </div>
